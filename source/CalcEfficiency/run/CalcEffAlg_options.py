...
#acf.FilesInput += [
#"/gpfs/home/yfukuhar/yazawa-root-file/data15_13TeV.00276511.physics_Main.merge.AOD.r7562_p2521/AOD.07709530._000199.pool.root.1"
...
#--------------------------------------------------------------------
# Additional setups for 2016 DAOD_MUON0
#-------------------------------------------------------------------
...
job += CalcEffAlg( message = "2",
                   OutputLevel = ERROR,
                   OutputFile = "test_data15_1225_05.root",
                   TapMethod = "NoTag",
                   Extrapolate = True,
                   GRL = False,
                   DataType = "data17"
